...
#define S_O(r,c) OFFSET(r,c,32)
#define S_O_8(r,c) OFFSET(r,c,16)
#define S_O_64(r,c) OFFSET(r,c,4)
#define S_O_32(r,c) OFFSET(r,c,8)
...
typedef struct {
    ...
    int rCount;
    int cCount;
    unsigned short *spriteAttr2;
    unsigned short *spriteAttr0;
    unsigned short *spriteAttr1;
} Sprite;
